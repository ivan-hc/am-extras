...
| addgroup | No description available | None |
...
| awk | Pattern scanning and processing language | None |
...
| chat | Automated conversational script with a modem | None |
...
| chpst | No description available | None |
...
| conspy | Remote control of Linux virtual consoles | None |
...
| crc32 | No description available | None |
...
| date | A header-only library which builds upon chrono | None |
...
| dumpleases | No description available | None |
...
| envdir | No description available | None |
| envuidgid | No description available | None |
...
| factor | A general purpose, dynamically typed, stack-based programming language. | None |
...
| fgrep | No description available | None |
...
| freeramdisk | No description available | None |
...
| getty | No description available | None |
...
| httpd | No description available | None |
...
| java | No description available | None |
...
| killall5 | No description available | None |
| klogd | No description available | None |
...
| loadfont | No description available | None |
...
| makemime | No description available | None |
...
| npx | No description available | None |
...
| openarena-quake3e | A Community-Produced Deathmatch FPS Based on GPL idTech3 Technology (Quake3e Engine) | None |
...
| pscan | No description available | None |
...
| pwdx | No description available | None |
...
| quake3e | Improved Quake III Arena Engine | None |
...
| rdate | Retrieves the date and time from other machines | None |
...
| redis-cli | No description available | None |
| reformime | No description available | None |
| remove_shell | No description available | None |
...
| resume | No description available | None |
...
| run_init | No description available | None |
| run_parts | No description available | None |
| runlevel | No description available | None |
| runsv | No description available | None |
...
| script | Command to supervise interactive execution of another command, such as the shell. | None |
...
| sendmail | A general purpose internetwork email routing MTA | None |
...
| setuidgid | No description available | None |
...
| smemcap | No description available | None |
| socat | Multipurpose relay | http://www.dest-unreach.org/socat/ |
| softlimit | No description available | None |
...
| tcpsvd | No description available | None |
...
| test2 | No description available | None |
...
| traceroute6 | No description available | None |
...
| tunctl | No description available | None |
...
| udhcpd | No description available | None |
| udpsvd | No description available | None |
...
| vconfig | No description available | None |
