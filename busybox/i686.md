...
| ------- | ----------- | ---- | -------- | ------- |
| acpid | A daemon for delivering ACPI power management events with netlink support | https://sourceforge.net/projects/acpid2/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ACPID | 1.35.0-i686-linux-musl |
| add_shell | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ADD_SHELL | 1.35.0-i686-linux-musl |
| addgroup | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ADDGROUP | 1.35.0-i686-linux-musl |
| adduser | Interactive front end to /usr/bin/useradd from Slackware Linux | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ADDUSER | 1.35.0-i686-linux-musl |
| adjtimex | Allows configuration of kernel time variables | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ADJTIMEX | 1.35.0-i686-linux-musl |
| ar | Create, modify, and extract from archives | https://www.gnu.org/software/binutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_AR | 1.35.0-i686-linux-musl |
| arp | Manipulate the system ARP cache | http://net-tools.sourceforge.net/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ARP | 1.35.0-i686-linux-musl |
| arping | Send ARP REQUEST to a neighbour host | https://github.com/iputils/iputils | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ARPING | 1.35.0-i686-linux-musl |
| ascii | Utility for conversion between various byte representations and the ASCII character table | http://www.catb.org/~esr/ascii | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ASCII | 1.35.0-i686-linux-musl |
| ash | An immutable tree-shaped meta-distribution using snapshots. | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_ASH | 1.35.0-i686-linux-musl |
| awk | Pattern scanning and processing language | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_AWK | 1.35.0-i686-linux-musl |
| base32 | Base32 encode/decode data and print to standard | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BASE32 | 1.35.0-i686-linux-musl |
| base64 | Base64 encode/decode data and print to standard | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BASE64 | 1.35.0-i686-linux-musl |
| basename | Strip directory and suffix from filenames | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BASENAME | 1.35.0-i686-linux-musl |
| bb_arch | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BB_ARCH | 1.35.0-i686-linux-musl |
| bb_sysctl | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BB_SYSCTL | 1.35.0-i686-linux-musl |
| bc | An arbitrary precision calculator language | https://www.gnu.org/software/bc/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BC | 1.35.0-i686-linux-musl |
| blkdiscard | Discard sectors on a device | https://github.com/util-linux/util-linux | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BLKDISCARD | 1.35.0-i686-linux-musl |
| blkid | Locate/print block device attributes | https://github.com/util-linux/util-linux | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BLKID | 1.35.0-i686-linux-musl |
| blockdev | Call block device ioctls from the command line | https://github.com/util-linux/util-linux | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BLOCKDEV | 1.35.0-i686-linux-musl |
| bootchartd | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BOOTCHARTD | 1.35.0-i686-linux-musl |
| brctl | Ethernet bridge administration | https://wiki.linuxfoundation.org/networking/bridge | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BRCTL | 1.35.0-i686-linux-musl |
| bunzip2 | - a block-sorting file compressor, v1.0.8 | https://sourceware.org/bzip2/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BUNZIP2 | 1.35.0-i686-linux-musl |
| bzcat | - a block-sorting file compressor, v1.0.8 | https://sourceware.org/bzip2/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BZCAT | 1.35.0-i686-linux-musl |
| bzip2 | A high-quality data compression program | https://sourceware.org/bzip2/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_BZIP2 | 1.35.0-i686-linux-musl |
| cal | Display a calendar | https://github.com/util-linux/util-linux | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_CAL | 1.35.0-i686-linux-musl |
| cat | Concatenate files and print on the standard output | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_CAT | 1.35.0-i686-linux-musl |
| chat | Automated conversational script with a modem | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_CHAT | 1.35.0-i686-linux-musl |
| chattr | Change file attributes on a Linux file system | http://e2fsprogs.sourceforge.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_CHATTR | 1.35.0-i686-linux-musl |
| chgrp | Change group ownership | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_CHGRP | 1.35.0-i686-linux-musl |
| chmod | Change file mode bits | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_CHMOD | 1.35.0-i686-linux-musl |
...
| dnsd | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_DNSD | 1.35.0-i686-linux-musl |
...
| flash_unlock | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_FLASH_UNLOCK | 1.35.0-i686-linux-musl |
...
| i2cdump | Examine I2C registers | https://i2c.wiki.kernel.org/index.php/I2C_Tools | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_I2CDUMP | 1.35.0-i686-linux-musl |
...
| link | Call the link function to create a link to a file | https://www.gnu.org/software/coreutils/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_LINK | 1.35.0-i686-linux-musl |
...
| mim | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_MIM | 1.35.0-i686-linux-musl |
...
| nsenter | Run program in different namespaces | https://github.com/util-linux/util-linux | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_NSENTER | 1.35.0-i686-linux-musl |
...
| readprofile | Read kernel profiling information | https://github.com/util-linux/util-linux | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_READPROFILE | 1.35.0-i686-linux-musl |
...
| setkeycodes | Load kernel scancode-to-keycode mapping table | http://www.kbd-project.org | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_SETKEYCODES | 1.35.0-i686-linux-musl |
...
| svok | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_SVOK | 1.35.0-i686-linux-musl |
...
| tunctl | No description available | https://busybox.net | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_TUNCTL | 1.35.0-i686-linux-musl |
...
| vi | The original ex/vi text editor | https://ex-vi.sourceforge.net/ | https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox_VI | 1.35.0-i686-linux-musl |
